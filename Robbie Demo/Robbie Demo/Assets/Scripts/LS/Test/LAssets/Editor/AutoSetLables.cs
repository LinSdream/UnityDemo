...
*/
    ...
    public class DeleteAB
    {
        ...
        public static void DeleteAllAB()
        {
            ...
            strABNeedPathDir = PathTools.AB_OutPath;
    ...
    {
        [MenuItem("ABTools/Build Android")]
        public static void BuildAndroid()
        {
            string strABOutPathDir = string.Empty;

            strABOutPathDir = PathTools.AB_OutPath;
        ...
        [MenuItem("ABTools/Bulid Local AB Android")]
        public static void BulidLocalAB_Android()
        {
            string strABOutPathDir = string.Empty;

            strABOutPathDir = PathTools.LocalAB_OutPath;
            if (!Directory.Exists(strABOutPathDir))
            {
                Directory.CreateDirectory(strABOutPathDir);
            }
        ...
        [MenuItem("ABTools/Build Window64")]
        ...
        [MenuItem("ABTools/Bulid Local AB Window64")]
        public static void BulidLocalAB_Window64()
        {
            string strABOutPathDir = string.Empty;
        ...
        //[MenuItem("ABTools/BuildAndSaveInfoListAllAB")]
        //public static void BuildAndSaveInfoListAllAB()
        //{
        //    string strABOutPathDir = string.Empty;
        ...
        //    var asset = BuildPipeline.BuildAssetBundles(strABOutPathDir, BuildAssetBundleOptions.None, BuildTarget.StandaloneWindows64);
        //    var abList = asset.GetAllAssetBundles();
    ...
    public class AutoSetLables
    {
        ...
        public static void SetABLable()
        {
            ...
            strNeedSetLableRoot = PathTools.AB_RessourcePath;
            //获取路径下所有文件夹
